...
ActiveRecord::Schema[7.2].define(version: 2024_11_15_185915) do
  ...
  create_table "notes", force: :cascade do |t|
    ...
    t.index ["weekly_plan_id"], name: "index_notes_on_weekly_plan_id"
  end
  ...
  add_foreign_key "notes", "weekly_plans"
